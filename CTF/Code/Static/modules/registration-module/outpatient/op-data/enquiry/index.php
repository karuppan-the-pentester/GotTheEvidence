...
if (isset($_GET['user'])) {
  $id = $_GET['user'];
  $Select_Data = "SELECT * FROM `op-data` WHERE id=$id;";
  $Result_Data = mysqli_query($connection, $Select_Data);
  $data = mysqli_fetch_assoc($Result_Data);
} else {
  header('Location: ../' . $uri);
}
if (isset($_POST['delete'])) {
  $delete_query = "DELETE FROM `op-data` WHERE `op-data`.`id` = $id";
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="form-sample" action="./index.php?user=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
                ...
                <h4 class="card-title">OutPatient Complete Data </h4>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="aadhar" value="<?php print_r($data['aadhaar']); ?>" />
                      </div>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input class="form-control" placeholder="dd/mm/yyyy" name="dob" value="<?php print_r($data['dob']); ?>" />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="eaddr" value="<?php print_r($data['eaddr']); ?>" />
                      </div>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="relation" value="<?php print_r($data['relation']); ?>" />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="reason" value="<?php print_r($data['reason']); ?>" />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <select class="form-control" style="color:black" name="atname" id="selectat">
                          <?php
                  ...
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <select class="form-control" name="drname" style="color:black" id="selectdr">
                          <?php
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="regdate" value="<?php print_r($data['regdate']); ?>" />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                ...
                <button type="submit" class="btn btn-primary" style="float:right" name="submit">Edit</button>
              </form>
              <?php
              if (isset($_POST['submit'])) {
                $name = $_POST['name'];
...
";
  ...
  <script>
    const changeSelected = (e) => {
      ...
      const $atselect = document.querySelector('#selectat');
      $atselect.value = '<?php print_r($data['atname']) ?>';
      const $drselect = document.querySelector('#selectdr');
