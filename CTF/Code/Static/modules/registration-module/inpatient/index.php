...
$queryforipdno="SELECT `ipdno` FROM `ip-data` ORDER BY ID DESC LIMIT 1; ";
$ipdno_result=mysqli_query($connection,$queryforipdno);
while($val=mysqli_fetch_assoc($ipdno_result)){
  $ipdnor=$val['ipdno'];
  $ipd=$ipdnor+1;
}
    ...
    <div class="main-panel">
      <div class="content-wrapper">
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">InPatient Registration </h4>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="ipdno" value="<?php echo $ipd;?>" />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <select class="form-control" name="marital_status" style="color:black">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="medicaldiag" />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="doa" placeholder="dd/mm/yyyy" />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="dod" placeholder="dd/mm/yyyy" />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              if (isset($_POST['submit'])) {
                ...
                $gaurdian = !empty($gaurdian) ? "'$gaurdian'" : "NULL";
                $place = !empty($place) ? "'$place'" : "NULL";
                $paddr = !empty($paddr) ? "'$paddr'" : "NULL";
                $medicaldiag = !empty($medicaldiag) ? "'$medicaldiag'" : "NULL";
                $drname = !empty($drname) ? "'$drname'" : "NULL";
                $doa = !empty($doa) ? "'$doa'" : "NULL";
