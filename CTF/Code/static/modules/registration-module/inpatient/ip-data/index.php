<?php
include '../../../../db.php';
$Selcet_Data = "SELECT DISTINCT `doa` FROM `ip-data` ORDER BY `doa` DESC;;";
            ...
            <div class='content-wrapper'>
                    ...
                    <div class='col-sm-12'>
                        <div class='home-tab'>
                            <div class='d-sm-flex align-items-center justify-content-between border-bottom'>
                                <h4 class='card-title'>InPatient Data Record</h4>
                                <div>
                ...
                <div class='col-lg-12 grid-margin stretch-card'>
                    <div class='card'>
                        ...
                        " ?>
                    <?php
                    $inst_data = "SELECT * FROM `ip-data` WHERE `doa`='$date' ORDER BY `id` DESC;  ";
                    ...
                    ?>
                <?php
                    $inst__Data = "SELECT SUM(`fee`) FROM `ip-data` WHERE `doa`='$date' ORDER BY `id` DESC; ";
