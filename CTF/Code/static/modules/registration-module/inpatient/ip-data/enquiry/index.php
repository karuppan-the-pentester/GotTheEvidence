...
if (isset($_GET['user'])) {
  $id = $_GET['user'];
  $Select_data = "SELECT * FROM `ip-data` WHERE `id`=$id; ";
  $data_result = mysqli_query($connection, $Select_data);
  $data = mysqli_fetch_assoc($data_result);
} else {
  header('Location: ../' . $uri);
}
if (isset($_POST['delete'])) {
  $delete_query = "DELETE FROM `ip-data` WHERE `ip-data`.`id` = $id";
...
?>
  <script type="text/javascript">
    window.location = "./index.php?user=<?php echo $id; ?>";
  </script>
<?php
}
?>
  ...
  <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
    ...
    <div class="navbar-menu-wrapper d-flex align-items-top">
      ...
      <ul class="navbar-nav ms-auto">
        <li>
          <a href="../../">
            <i class=" mdi mdi-pencil-box-outline " style="font-size:2rem;padding:10px;"></i>
          </a>
        </li>
        <li>
          <a href="../.././ip-data/">
  ...
  <div class="container-fluid page-body-wrapper">
    ...
    <div class="main-panel">
      <div class="content-wrapper">
              ...
              <div class='d-sm-flex align-items-center justify-content-between border-bottom'>
                ...
                <div>
                  <div class='btn-wrapper'>
                    <a href='../../../../export-module/case-sheet/index.php?ipd=<?php echo $id ?>' class='btn btn-otline-dark'><i class='icon-download'></i> Case-Sheet</a>
                    <a href='../../../../export-module/discharge-summary/index.php?ipd=<?php echo $id ?>' class='btn btn-otline-dark'><i class='icon-download'></i> Summary</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              <form class="form-sample" action="./index.php?user=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
                <button type="submit" class="btn btn-danger" style="float:right" name="delete">Delete</button>
                <h4 class="card-title">InPatient Details</h4>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">IPD Reg No</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="ipdno" value="<?php print_r($data['ipdno']); ?>" />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="name" value="<?php print_r($data['name']); ?>" />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="age" value="<?php print_r($data['age']); ?>" />
                      </div>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <select class="form-control" name="gender" id="genderselect" style="color:black">
                          <option value="Select The Gender">Select The Gender</option>
                  ...
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input class="form-control" name="occupation" value="<?php print_r($data['occupation']); ?>" />
                      </div>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <select class="form-control" name="marital_status" id="maritalselect" style="color:black">
                  ...
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="eno" value="<?php print_r($data['eno']); ?>" />
                      </div>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="pno" value="<?php print_r($data['pno']); ?>" />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">Gaurdian Name</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="gaurdian" value="<?php print_r($data['gaurdian']); ?>" />
                      </div>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="place" value="<?php print_r($data['place']); ?>" />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="paddr" value="<?php print_r($data['paddr']); ?>" />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">Medical Diagnosis</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="medicaldiag" value="<?php print_r($data['medicaldiag']); ?>" />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <select class="form-control" name="drname" id="drselect" style="color:black">
                          <?php
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="doa" placeholder="dd/mm/yyyy" value="<?php print_r($data['doa']); ?>" />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="dod" placeholder="dd/mm/yyyy" value="<?php print_r($data['dod']); ?>" />
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="fees" value="<?php print_r($data['fee']); ?>" />
                    </div>
                  </div>
                </div>
              ...
              if (isset($_POST['submit'])) {
                ...
                $place = $_POST['place'];
                $paddr = $_POST['paddr'];
                $medicaldiag = $_POST['medicaldiag'];
                $drname = $_POST['drname'];
                $doa = $_POST['doa'];
                $dod = $_POST['dod'];
                $fees = $_POST['fees'];

                $Insert_Query_Data = "UPDATE `ip-data` SET 
              `ipdno` = '$ipdno',
              `doa` = '$doa',
              `name` = '$name',
              `age` = '$age',
    ...
    <script>
      const changeSelected = (e) => {
        ...
        $genderselect.value = '<?php print_r($data['gender']); ?>';
        const $maritalselect = document.querySelector('#maritalselect');
        $maritalselect.value = '<?php print_r($data['marital_status']); ?>';
        const $drselect = document.querySelector('#drselect');
        $drselect.value = '<?php print_r($data['drname']); ?>';
      };
      changeSelected();
    </script>
</body>
